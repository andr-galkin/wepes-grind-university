    ...
    <div>
      ...
      <div className="px-10 py-20">
        ...
        <BodyText
          ...
          color="text-black-100"
        >
          a conceptual community created by Kyiv youth to generate and realize
          ideas in various spheres based on individual experience, aesthetic and
          general views observing a certain list of rules. An example of an
          initiative that unites youth around common interests and promotes the
          development of creative potential in the urban environment.
        </BodyText>
      </div>
      <div className="px-10 py-20">
        <BodyText
      ...
      <div className="px-10 py-20">
        ...
        >
          ALL SALES ARE FINAL.
          <br />
          <br /> We Do Not Offer Returns or Exchanges for Anything. Refer to the
          size charts provided with each product before making your purchase.
          <br />
          <br />
